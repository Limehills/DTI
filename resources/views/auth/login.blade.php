  ...
  <div class="bg-white/10 backdrop-blur-lg border border-white/10 rounded-2xl shadow-2xl p-1 w-full max-w-md">
    <div class="bg-[#f4f4f4] text-gray-800 rounded-2xl px-10 py-12 shadow-inner">
      <div class="flex flex-col items-center mb-10">
        <img src="pic/logo2.png" alt="DTR Logo" class="w-20 h-20 mb-3 rounded-full shadow-lg border border-blue-500/30">
      ...
      <form action="login" method="post" class="space-y-6"> @csrf
        <div>
          <label for="username" class="block text-sm font-semibold uppercase tracking-wide mb-1 text-gray-700">Username</label>
      ...
      <p class="mt-8 text-center text-sm text-gray-600 font-medium">
        ...
        <a href="{{ url('/register') }}" class="text-blue-600 font-bold hover:underline">Sign up now</a>
      </p>
    </div>
  </div>
</body>
